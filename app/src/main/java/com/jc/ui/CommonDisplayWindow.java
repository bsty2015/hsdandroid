 ...
 */
public class CommonDisplayWindow extends PopupWindow {
    ...
    public CommonDisplayWindow(Activity context, int layoutId){
        super(context);
    ...
    public static CommonDisplayWindow show(Activity context, int layoutId){
        return new CommonDisplayWindow(context,layoutId);
    }
}
