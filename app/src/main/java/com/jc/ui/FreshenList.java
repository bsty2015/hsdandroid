...
public class FreshenList extends ListView implements OnScrollListener {
        ...
        public FreshenList(Context context) {
            super(context);
            init(context);
        }

        public FreshenList(Context context, AttributeSet attrs) {
            super(context, attrs);
            init(context);
        }
        ...
        private void init(Context context) {
            ...
            setCacheColorHint(com.jc.R.string.transparent);
            inflater = LayoutInflater.from(context);
            headView = (LinearLayout) inflater.inflate(com.jc.R.layout.pull_to_refresh, null);
            arrowImageView = (ImageView) headView
                    .findViewById(com.jc.R.id.head_arrowImageView);
            arrowImageView.setMinimumWidth(70);
            arrowImageView.setMinimumHeight(50);
            progressBar = (ProgressBar) headView
                    .findViewById(com.jc.R.id.head_progressBar);
            tipsTextview = (TextView) headView.findViewById(com.jc.R.id.head_tipsTextView);
        ...
        private void changeHeaderViewByState() {
            switch (state) {
                ...
                case DONE:
                    ...
                    progressBar.setVisibility(View.GONE);
                    arrowImageView.clearAnimation();
                    arrowImageView.setImageResource(com.jc.R.mipmap.xiala);
                    tipsTextview.setText("加载完毕... ");
                   // lastUpdatedTextView.setVisibility(View.VISIBLE);
                    break;
            }
        }
